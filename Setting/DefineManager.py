...
OBJECT_DETECT_TESTCASE_PATH = "Tests/testcase11/"
...
FUNCTION_DIMENSION  = 1         #For SciPy polyfit
...
KOREAN_GOLDEN_RATIO = 1.4
MINIMUM_STRIDE_KEY = 2
ANGLE_AS_DEAL_WITH_POINT =10 # GetContour.AngleAsDealWithPointFromContours
...
# Use These Various From RecoverTheLengthModule.py
X_POSITION_SAVE_POINT = 0
Y_POSITION_SAVE_POINT = 1
ZERO_POSITION = [0, 0]
INCLINATION_SAVE_POINT = 0
CONSTANT_VALUE_SAVE_POINT = 1
ZERO = 0